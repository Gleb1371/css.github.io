document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchClients() {
        fetch('/clients')
            ...
            .then(data => {
                ...
                const filteredClients = data.clients.filter(client => client.role === 'classes');
        ...
        fetch(`/clients/${clientId}`)
            ...
            .then(data => {
                ...
                document.getElementById('editTripForm').onsubmit = function(event) {
                    ...
                    const updatedClient = { first_name: enteredUsername, phone_number: enteredNumber, role: 'classes' };
    ...
    addTripForm.addEventListener('submit', function(event) {
        ...
        const newClient = { first_name: enteredUsername, phone_number: enteredNumber, role: 'classes' };
        fetch('/clients', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
